...
Version  : 3.33.92
Release  : 22
URL      : https://download.gnome.org/sources/gnome-panel/3.33/gnome-panel-3.33.92.tar.xz
Source0  : https://download.gnome.org/sources/gnome-panel/3.33/gnome-panel-3.33.92.tar.xz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568080041
