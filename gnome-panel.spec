...
Version  : 3.36.1
Release  : 27
URL      : https://download.gnome.org/sources/gnome-panel/3.36/gnome-panel-3.36.1.tar.xz
Source0  : https://download.gnome.org/sources/gnome-panel/3.36/gnome-panel-3.36.1.tar.xz
...
%prep
%setup -q -n gnome-panel-3.36.1
cd %{_builddir}/gnome-panel-3.36.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585778502
...
cp %{_builddir}/gnome-panel-3.36.1/COPYING %{buildroot}/usr/share/package-licenses/gnome-panel/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/gnome-panel-3.36.1/COPYING-DOCS %{buildroot}/usr/share/package-licenses/gnome-panel/4f485ab7059ac53d9e3818278ad82217ce976a36
cp %{_builddir}/gnome-panel-3.36.1/COPYING.LESSER %{buildroot}/usr/share/package-licenses/gnome-panel/3704f4680301a60004b20f94e0b5b8c7ff1484a9
cp %{_builddir}/gnome-panel-3.36.1/COPYING.LIB %{buildroot}/usr/share/package-licenses/gnome-panel/ba8966e2473a9969bdcab3dc82274c817cfd98a1
%make_install
...
/usr/share/gtk-doc/html/libgnome-panel/deprecated-api-index.html
