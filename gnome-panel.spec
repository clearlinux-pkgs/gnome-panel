...
Version  : 3.32.0
Release  : 21
URL      : https://download.gnome.org/sources/gnome-panel/3.32/gnome-panel-3.32.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-panel/3.32/gnome-panel-3.32.0.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1557079056
export AR=gcc-ar
